...
public class Lwjgl3D3D11Application implements Lwjgl3ApplicationBase {
    ...
    public Lwjgl3D3D11Application (ApplicationListener listener) {
        this(listener, new Lwjgl3ApplicationConfiguration());
    }

    public Lwjgl3D3D11Application (ApplicationListener listener, Lwjgl3ApplicationConfiguration config) {
